...
# Namespace
kubectl apply -f ${DIR}/../k8s/${1}/00-namespace.yml 

# Config map
kubectl apply -f ${DIR}/../k8s/${1}/01-config-map.yml -n=k8s-test-${1}

# Secret map
kubectl apply -f ${DIR}/../k8s/${1}/01-secret-map.yml -n=k8s-test-${1}

kubectl apply -f ${DIR}/../k8s -n=k8s-test-${1}
# Data service
